...
const DISMISS_KEY = 'friska_install_prompt_dismissed';
...
export default function InstallProvider({ children }) {
    ...
    return (
        <InstallContext.Provider value={{ canInstall, promptInstall, openSheet }}>
            {children}
            {show && !standalone && (
                    ...
                    <div className="install-prompt-card" role="dialog" aria-label="Add to Home Screen">
                        ...
                        {ios ? (
                            ...
                            <>
                                ...
                                <button className="install-prompt-btn" onClick={promptInstall}>
