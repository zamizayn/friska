class ApiConfig {
  ...
  static String get settings => '$baseUrl/tenants/me/settings';
  static String get globalConfigs => '$baseUrl/global-configs';
  static String get deliveryBoys => '$baseUrl/delivery-boys';
  ...
  static String orderAssignDelivery(int id) =>
      '$baseUrl/orders/$id/assign-delivery';
  static String customerOrders(String phone) =>
      '$baseUrl/customers/$phone/orders';
  static String customerLogs(String phone) =>
      '$baseUrl/customers/$phone/logs';
}
